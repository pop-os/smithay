...
impl<A: GraphicsApi> GpuManager<A> {
    ...
    pub fn single_renderer<'api>(
        ...
        if !self.devices.iter().any(|dev| dev.node() == device) || self.api.wants_enumeration() {
            self.api
        ...
        <B::Device as ApiDevice>::Renderer: ImportDma,
    {
        if !render_api
            ...
            || render_api.api.wants_enumeration()
        {
            render_api
                .api
        ...
        if !target_api
            ...
            || target_api.api.wants_enumeration()
        {
            target_api
                .api
